...
public class Exec {
    public static void runInThreads() {
        try {
            ...
            futures.add(executorService.submit(new DistrictECourtRunnable(caseId, service, targetName, search_date, searchedBy, requestId, serviceId,  "2025", state, district, courtComplex,null, numList, "wb.xlsx" )));
